...
<!-- cspell:ignore pdfplumber ooxml -->
...
Agent Skills are specialized instruction sets that extend AI agent capabilities with domain-specific knowledge,workflows, and tool integrations. They follow the [agentskills.io](https://agentskills.io) open format and work with multiple AI coding agents (Claude Code, VS Code Copilot, Cursor, Windsurf).
...
- ✅ Good: `writing-documentation`, `adding-services`, `managing-backups`
