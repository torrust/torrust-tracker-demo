...
<!-- cspell:ignore clippy shellcheck scannability -->

This document provides concrete examples of Agent Skills from the Torrust Tracker Demo project and Anthropic's skills repository.
...
### Example 1: add-new-skill Skill (Meta-Skill)
...
**Pattern used**: High-level guide with references (Pattern 1 from patterns.md) 4. Frontmatter Reference 5. Body Patterns 6. Bundled Resources Best Practices 7. Validation and Integration
