...
- Is the absence of an observed `Strict-Transport-Security` header intentional
  for the demo, or just missing edge hardening?
...
- Decide whether missing HSTS on the public HTTPS hosts is an acceptable demo
  tradeoff or worth treating as a low-severity hardening issue.
