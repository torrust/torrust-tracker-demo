...
---
name: skill-name
description: Skill description as a plain single-line string.
metadata:
  author: organization-name
  version: "1.0"
  last-updated: "2026-02-06"
allowed-tools: Read Bash(npx markdownlint-cli2:*)
compatibility: Requires Node.js for linting tools.
---
```
...
## Importable Skill Libraries

Ready-made skills you can copy or adapt:

- **Anthropic skills** — <https://github.com/anthropics/skills>
  Official collection including `skill-creator`, `github-pr-review`, and others.
- **augmentedcode-configuration** — <https://github.com/saski/augmentedcode-configuration/tree/main/.agents/skills>
  Large library of engineering methodology skills: TDD, BDD, hexagonal architecture,
  refactoring, approval tests, event modeling, code simplifier, and more. Generic
  enough to reuse across projects.
