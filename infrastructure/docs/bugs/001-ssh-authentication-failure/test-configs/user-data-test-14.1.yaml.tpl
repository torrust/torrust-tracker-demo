#cloud-config
# Test 14.1: Add additional UFW rules for Torrust-specific ports
# Based on Test 13.1 + additional UFW rules (6868/udp, 6969/udp, 7070/tcp, 1212/tcp)
...
# Final message
final_message: |
  Test 14.1: Torrust Tracker Demo VM with additional UFW rules
  
  Added: Additional UFW rules for Torrust ports (6868/udp, 6969/udp, 7070/tcp, 1212/tcp)
  
  SSH Access:
  - SSH Key: ssh torrust@VM_IP
  - Password: sshpass -p 'torrust123' ssh torrust@VM_IP

  Testing additional UFW firewall rules...
